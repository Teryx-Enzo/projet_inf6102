...
def choix_piece(i,j,solution,pieces,puzzle:EternityPuzzle):
    ...
    couleurs_voisins = set((c_nord,c_sud,c_ouest,c_est))
    for piece in pieces_possibles:
        ...
        for k in range(0,4):
            ...
            score = len(couleurs_voisins.intersection(set(piece_permuted)))
    ...
    if isinstance(best,np.ndarray):
        best_piece = pieces[best[0]]
    else:
        best_piece = pieces[best]
